...
@dataclass
class PillarPage:
    def __init__(self, title: str, supporting_pages: list[str] = [], supporting_blog_topics: list[str] = []):
        self.title = title
        self.supporting_pages = supporting_pages
        self.supporting_blog_topics = supporting_blog_topics

    def __repr__(self):
        return (f"PillarPage(title={self.title}, "
                f"supporting_pages={self.supporting_pages}, "
